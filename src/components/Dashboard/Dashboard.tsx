...
const Dashboard: React.FC = () => {
  return (
    <div className="py-8 w-full">
      {/* Hero Section */}
      <div className="bg-blue-950 px-6 py-8 w-full overflow-hidden relative">
        ...
        <div className="relative z-10 flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            <button className="py-2 px-6 bg-indigo-900 text-white rounded-lg hover:bg-indigo-800 transition-colors">
              Free Trial
            </button>
            <button className="py-2 px-6 bg-white text-indigo-600 rounded-lg hover:bg-gray-100 transition-colors">
              Start Challenge
            </button>
          </div>
        </div>
